...
const TodoCard = (props) => {
  ...
  return (
      <div className='bg-red-400 my-5 w-[264px] relative  h-[240px] rounded-xl p-7 mr-9' style={{ backgroundColor: randomBg }}>
        <div>
          <img src={edit} className='cursor-pointer w-7 absolute top-[29px] right-[25px] '></img>
          <h2 className='text-xl font-bold underline mb-3 line-clamp-1'>{props.title}</h2>  
        </div>   
        <div>
          <p className='font-medium text-lg line-clamp-4'>{props.description}</p>
        </div>
        <div>
